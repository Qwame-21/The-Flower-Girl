...
export default function CustomizePage({ onNavigate }) {
  ...
  return <main className="content-page customize-page">
    ...
    <div className="custom-builder"><form onSubmit={submit}>
      ...
      <div className="custom-contact"><label>Name<input name="name" required /></label><PhoneInput label="WhatsApp number" required /><DateField label="Preferred date" prefix="custom" /></div>
